...
- The BeeGees pipeline has the capacity to validate the following barcode markers:
 ...
 - **rbcL**: Requires [custom reference](https://doi.org/10.6084/m9.figshare.17040680.v5) BLASTn rbcL database and corresponding taxonomy mapping TSV file (NCBI_rbcL_Viridiplantae_fasta_file_dereplicated_\*.fasta & NCBI_rbcL_Viridiplantae_taxonomic_lineages_dereplicated_\*.tsv), downloaded [here](https://figshare.com/ndownloader/files/56104238).
